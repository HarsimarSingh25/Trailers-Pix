...
class Movie(object):
    ...
    Attributes:
        ...
        starring: A string to store the names of starcast of the movie. 
        director: A string to store the name of the director of the movie.
        release_date: A string to store the release date of the movie.
    """

    def __init__(self, movie_title, movie_storyline, poster_image,
                 trailer_youtube, starring, director, movie_release_date):
